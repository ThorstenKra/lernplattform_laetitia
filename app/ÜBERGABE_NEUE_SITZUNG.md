...
- ⬜ **Nächste Schritte:** (1) Nova nochmal live gegentesten (Geschichten-Entfernung, bisher nur syntaxgeprüft), (2) Coach-Agent planen, (3) Bibliotheksformat für den Coach-Agenten konkretisieren (Anbindung an `LaetitiaStats`), (4) irgendwann: `registry.js` tatsächlich in eine Auswahl-UI einbinden, Grundkonzept für Gruppengespräche (Turn-Taking, Gemini-Freikontingent-Verbrauch bei mehreren gleichzeitigen KI-Stimmen).
