...
**Vollständig verifiziert:** Nova/Fabu/Milo einzeln per `curl` (jeweils charaktertypische echte Antwort), danach der neue Gruppenchat live über 3 echte Gesprächsrunden mit dynamischen Antworten (Nova → Fabu bei „erzähl mir eine Geschichte" → Milo bei „hilfe bei mathe", jeweils voll in Charakter), sowie Milos Logik-Online-Tipp (Stufe B, gibt jetzt einen echten sokratischen Denkanstoß statt Offline-Fallback). Keine Konsolenfehler.
