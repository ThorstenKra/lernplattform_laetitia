...
- 🟡 **Avatar Stufe 2 (Idee, noch nicht geplant):** Für weichere/fließendere Mimik/Gestik bräuchte es entweder eine Illustration+Animation von einer Zeichnerin/einem Zeichner, oder ein Animations-Tool wie Rive (State-Machine-basierte Charakteranimation, genau für zustandsabhängige Mimik gemacht) — beides braucht echte Charakter-Gestaltung, die nicht rein im Code entsteht.
