...
window.QUASSELKISTE_FELDER = [
  {r:1, c: 1, name:"Standard",  bg:"#FFFFFF", seiten:[1,2]},
  {r:1, c: 2, name:"ABC",       bg:"#FFFFFF", seiten:[1]},
  {r:1, c: 3, name:"Ja",        bg:"#FFFFFF", seiten:[1]},
  {r:1, c: 4, name:"Nein",      bg:"#FFFFFF", seiten:[1]},
  {r:1, c: 5, name:"Hallo",     bg:"#FFFFFF", seiten:[2]},
  {r:1, c: 6, name:"Cool",      bg:"#FFFFFF", seiten:[2]},
  {r:1, c: 7, name:"Bilder",    bg:"#FFFFFF", seiten:[1]},
  {r:1, c: 8, name:"Wort",      bg:"#FFFFFF", seiten:[1,2]},
  {r:1, c: 9, name:"Fußball",  bg:"#FFFFFF", seiten:[1,2,3]},
  {r:1, c:10, name:"",          bg:"#FFFFFF", seiten:[]},
  ...
  {r:3, c: 8, name:"Schlüssel", bg:"#F8A9D8"},
